...
pub struct CreateStreamAccounts<'info> {
    ...
    #[account(
        ...
        payer = payer,
        space = 500,
        // constraint = rate_amount_units > 0 @ ErrorCode::InvalidStreamRate, // For some reason this is sent equals to zero for OTP
        // constraint = rate_interval_in_seconds > 0 @ ErrorCode::InvalidStreamRate, // For some reason this is sent equals to zero for OTP
...
//         constraint = !(allocation_type == ALLOCATION_TYPE_ASSIGN_TO_SPECIFIC_STREAM && 
//             (
//                 allocation_stream == None || 
//                 allocation_stream == Some(Pubkey::default()) || 
//                 allocation_stream != Some(stream.key()))
//         ) @ ErrorCode::InvalidRequestedStreamAllocation,
//         constraint = !(
//             allocation_type == ALLOCATION_TYPE_ASSIGN_TO_SPECIFIC_STREAM && 
//             treasury.treasury_type == TREASURY_TYPE_LOCKED
//         ) @ ErrorCode::AddFundsNotAllowedOnLockedStreams
//     )]
//     pub treasury: Account<'info, Treasury>,
//     #[account(
//         init_if_needed,
...
//     #[account(
//         mut,
//         constraint = treasurer_treasury_token.mint == treasury_mint.key() @ ErrorCode::InvalidTreasuryMint,
//         constraint = treasurer_treasury_token.owner == treasurer.key() @ ErrorCode::InvalidOwner
//     )]
...
//         // associated_token::mint = associated_token,
//         // associated_token::authority = treasurer,
//         constraint = treasurer_treasury_token.mint == associated_token.key() @ ErrorCode::InvalidTreasuryMint,
//     )]
